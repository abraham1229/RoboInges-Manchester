...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'mensaje_personal.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from mensaje_personal.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from mensaje_personal.srv._add_three_ints import AddThreeInts_Request as Request
    from mensaje_personal.srv._add_three_ints import AddThreeInts_Response as Response
